...
#What to do with primers that were no originally part of the certain subgroup? like odt_5 and 6 of pool1_H+ group?
#they are found but should not be here. 
    #this is caused by the lack of i7 index and thus we cant group them based on pools 
#Then we have the data of control group along with relevant primers A,G,H and 5,6. Altho these are named as pool1-2, I guess
#I can manually assign them to the needed groups

#should I compare the All enriced groups with the R21 enriched ones
